            ...
            <div>
                ...
                <div className='containter-fluid text-center'>
                    <div className='row row justify-content-md-center'>
                        ...
                        {/**<div className='col-xxl-3 col-xl-5 col-lg-6 col-md-8 col-sm-10 col-xm-12'><img src='React Homepage.png' alt='In the works' /></div>
                        <div className='col-xxl-3 col-xl-5 col-lg-6 col-md-8 col-sm-10 col-xm-12'><img src='React Homepage.png' alt='In the works' /></div>

                        <div className="w-100 d-none d-md-block"></div>

                        <div className="col-xxl-3 col-xl-5 col-lg-6 col-md-8 col-sm-10 col-xm-12"><b>Track & Field- - - - -- - - - -- - - - -- - - - -- - - - -- - - - -</b></div>
                        <div className="col-xxl-3 col-xl-5 col-lg-6 col-md-8 col-sm-10 col-xm-12"><b>Cooking- - - - -- - - - -- - - - -- - - - -- - - - -- - - - -- - - - -</b></div>
                    */}</div> 
                </div>
