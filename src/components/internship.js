    ...
    return(
        <body>
            <div>
                ...
                <p className='paragraph'>I completed the other half of the <a href="https://www.youtube.com/watch?v=RGOj5yH7evk&ab_channel=freeCodeCamp.org"><u style={{"color" : "blue"}}>Crash Course.</u> </a>This went smoother than yesterday as through research and trying out various cloning methods, HTTPS was easier to clone with as it caused less errors compared to SSH. Once I finished the crash course. I watched a how to host my own. I was successfully able to host my own <a href="https://fabienthich.github.io"><u style={{"color" : "blue"}}>website</u></a> as seen on the left. I have made some improvements to the website and I am currently working on pushing it out and updating it.</p>
